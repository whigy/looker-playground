...
view: user_order_facts {
  ...
  dimension: number_of_orders_bucket {
    type: tier
...
#         COUNT(DISTINCT (order_items."ORDER_ID") ) AS "order_items.number_of_orders",
...
#   dimension: order_items_number_of_orders {
#     type: number
#     sql: ${TABLE}."order_items.number_of_orders" ;;
#   }
...
#   set: detail {
#     fields: [order_items_user_id, order_items_number_of_orders, order_items_total_sale_price, order_items_first_order_date, order_items_latest_order_date]
#   }
# }
